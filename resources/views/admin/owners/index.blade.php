                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 mx-auto">
                            <x-flash-message status="session('status')" />   {{-- statusはカラーを変更するフラグ --}}
                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-3">
                                            <button type="button" onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id]) }}'" class="text-white bg-green-400 border-0 py-2 px-4 focus:outline-none hover:bg-green-500 rounded">編集</button>
                                        </td>
